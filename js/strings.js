...
export const STRINGS = {
  en: {
    title: 'AT Progress Tracker',
    mapAriaLabel: 'Appalachian Trail map',
    fitBtn: 'View full trail',
    terrainBtn: '3D terrain',
    subtitle: 'Springer Mountain, GA to Mount Katahdin, ME',
    placeholderBanner: 'This is a placeholder route: about 58 waypoints connected by straight lines, not the real AT, and mileage is estimated. Run the data pipeline per SPEC.md to switch to the real route.',
    ...
    creditText: 'Hikes are only saved in this browser -- export a backup before switching devices. Trail: National Park Service Appalachian Trail Park Office & Appalachian Trail Conservancy. Place names: © OpenStreetMap contributors.',
    ...
    importedFlash: (n) => `Imported ${n} hike${n === 1 ? '' : 's'}`,
  ...
  zh: {
    title: 'AT 进度看板',
    mapAriaLabel: 'Appalachian Trail 地图',
    fitBtn: '看全程',
    terrainBtn: '3D 地形',
    subtitle: '乔治亚 Springer Mountain 到缅因 Mount Katahdin',
    placeholderBanner: '现在显示的是占位路线：用直线连起大约 58 个航点，不是真实的 AT，里程也是估算。按 SPEC.zh.md 运行数据脚本后会换成真实路线。',
    ...
    creditText: '记录只保存在这个浏览器里，换设备前先导出。路线：美国国家公园管理局 Appalachian Trail Park Office 与 Appalachian Trail Conservancy。地名：© OpenStreetMap 贡献者。',
