...
export const STRINGS = {
  en: {
    ...
    placeholderBanner: 'This is a placeholder route: about 58 waypoints connected by straight lines, not the real AT, and mileage is estimated. Run the data pipeline per the README to switch to the real route.',
  ...
  zh: {
    ...
    placeholderBanner: '现在显示的是占位路线：用直线连起大约 58 个航点，不是真实的 AT，里程也是估算。按 README 运行数据脚本后会换成真实路线。',
